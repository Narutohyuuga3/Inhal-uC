...
# 254 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\pic18_chip_select.h" 3
...
# 254 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\pic18_chip_select.h" 2 3
...
void warten(unsigned int dauer)
{
 ...
 {
  _delay((unsigned long)((0x01)*(64000000/4000.0)));
 }
...
void wartenuS(unsigned int dauer)
{
 for (unsigned int i = 0x00; i < dauer; i++)
 {
  _delay((unsigned long)((0x01)*(64000000/4000000.0))); }
