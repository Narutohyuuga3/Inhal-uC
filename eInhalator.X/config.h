 ...
 * Author: Creez
 *
 * Created on 3. Dezember 2020, 20:41
 */
...
// CONFIG1L
#pragma config FEXTOSC = OFF     // External Oscillator mode Selection bits (XT (crystal oscillator) above 100 kHz, below 8 MHz; PFM set to medium power)
#pragma config RSTOSC = HFINTOSC_64MHZ// Power-up default value for COSC bits (EXTOSC with 4x PLL, with EXTOSC operating per FEXTOSC bits)
